...
public class DispatcherServlet extends FrameworkServlet {
    ...
    private void initHandlerMappings(ApplicationContext context) {
        ...
        if (this.detectAllHandlerMappings) {
            ...
            logger.info("检测所有的handlerMapping，结果为" + handlerMappings);
        } else {
            try {
    ...
    private void initHandlerAdapters(ApplicationContext context) {
        ...
        if (this.detectAllHandlerAdapters) {
            ...
            /**
             * [org.springframework.web.servlet.mvc.method.annotation.RequestMappingHandlerAdapter@873f258,
    ...
    private void initHandlerExceptionResolvers(ApplicationContext context) {
        ...
        if (this.detectAllHandlerExceptionResolvers) {
            ...
            /**
             * ：[org.springframework.web.servlet.mvc.method.annotation.ExceptionHandlerExceptionResolver@5e4d9508,
             * org.springframework.web.servlet.mvc.annotation.ResponseStatusExceptionResolver@3cf096d0,
             * org.springframework.web.servlet.mvc.support.DefaultHandlerExceptionResolver@4e994c7c]
             */
            logger.info("检测所有的处理异常解析器，结果为：" + handlerExceptionResolvers);
        } else {
            try {
    ...
    private void initViewResolvers(ApplicationContext context) {
        ...
        if (this.detectAllViewResolvers) {
            ...
            // null
            logger.info("检测所有的视图解析器，结果为：" + viewResolvers);
        } else {
            try {
    ...
    protected void doService(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        logger.info("DispatcherServlet with name '" + getServletName() + "'" + resumed +
